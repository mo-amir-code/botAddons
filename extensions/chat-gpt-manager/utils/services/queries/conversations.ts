...
const getAllConversations = async ({
  ...
  const res = await getConversations({
    offset: 0,
    isArchived: archive === "archive" ? true : false
  })
  ...
  if (archive === "unarchive") dispatch({ type: "CHAT_LOADED", payload: 100 })
...
export { getConversations, updateConversation, getAllConversations }

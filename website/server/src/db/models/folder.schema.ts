...
const folderSchema: Schema<FolderSchemaType> = new Schema<FolderSchemaType>(
  {
    parent: { type: Schema.Types.ObjectId, ref: FOLDER_COLLECTION_NAME },
    userId: {
...
export default mongoose.models[FOLDER_COLLECTION_NAME] ||
  mongoose.model<FolderSchemaType>(FOLDER_COLLECTION_NAME, folderSchema);

...
import { createFolder, deleteFolderById, findFolderByIdAndUpdate } from "../../db/services/folder.db.service.js";
import { apiHandler, ok } from "../../services/errorHandling/index.js";
import { CreateFolderType } from "../../types/controllers/v1/folder.js";
import { FindFolderByIdAndUpdate, GetFoldersType } from "../../types/db/services/folder.types.js";
import { OriginType } from "../../types/index.js";
import { FOLDER_CREATED_RES_MSG, FOLDER_DELETED_RES_MSG, FOLDER_FETCHED_RES_MSG, FOLDER_UPDATE_RES_MSG } from "../../utils/constants/serverResponseMessages.js";
...
const getFoldersHandler = apiHandler(async (req, res) => {
    ...
    let origin = req.origin as OriginType;

    const folders = await Folder.find({ userId, type, platform: { $in: [origin, "all"] } });
